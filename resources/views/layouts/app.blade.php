            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="index.html" class="logo"><i class="md md-terrain"></i> <span>Munif Motors </span></a>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="">
                            ...
                            <ul class="nav navbar-nav navbar-right pull-right">
                                ...
                                <li class="dropdown">
                                    <a href="" class="dropdown-toggle profile" data-toggle="dropdown" aria-expanded="true"><img src="{{ URL::to('public/admin/images/momin.jpg') }}" alt="user-img" class="img-circle"> </a>
            ...
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li><a href="#">All Attendences</a></li>
                        ...
                        <footer class="footer text-left text-danger">
                            <b>2020 © IT Partner</b>
                        </footer>
    ...
    <script>  
        $(document).on("click", "#ad", function(e){
            ...
            swal({
                ...
                text: "If you want to do so, Pls press on button OK!",
                icon: "warning",
                buttons: true,
                dangerMode: true,
            })
