                            ...
                            <div class="col-md-12">
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h3 class="panel-title text-success" style="font-size:20px; text-align:center" >List of All Employee</h3>
                                    </div>
                                                ...
                                                <table id="datatable" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>                                                            
                                                            ...
                                                            <td>
                                                                <a class="btn btn-sm btn-info" href="{{ URL::to('edit-employee/'.$row->id) }}" id="edit">Edit</a>
                                                                <a class="btn btn-sm btn-danger" href="{{ URL::to('delete-employee/'.$row->id) }}" id="delete">Delete</a>
