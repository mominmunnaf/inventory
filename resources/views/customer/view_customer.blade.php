        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <div class="panel panel-default">
                    <div class="panel-heading"><h3 style="font-size:20px; text-align:center" class="panel-title text-success">View Customer </h3></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6 pull-right">
                                    ...
                                    <a class="btn btn-sm btn-danger " href="{{ route('add.customer') }}" id="ad">Add Customer</a>
                                    <a class="btn btn-sm btn-success " href="{{ route('all.customer') }}" id="all">All Customer List</a>
                                </div>
                            </div>
